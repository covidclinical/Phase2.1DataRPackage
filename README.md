...
The Phase 2.1 Data Pre-Processing is recommended for all sites before running the 4CE consortium Phase 2 project. The Phase 2.1 Data Pre-Processing consists of two parts: quality control and data cleaning. 


## Quality Control for Phase 2.1 Data
...
1. **QC for Phase 1.1 data**. We will check the following critera: 
+ Demographics:  
...
2. **QC for Phase 2.1 data**. We will check if the summary statistics obtained from Phase 2.1 patient-level data is consistent with Phase 1.1 aggregated data.

3. **Generate QC report**
QC report will be generated in word format. 


## Data pivot for Phase 2.1 Data
